...
export const TimeLineData = [
  { year: 2017, text: "Started my journey learning Java Fundamentals" },
  { year: 2018, text: "Studied Data Structures and Algorithms" },
  {
    year: 2019,
    text: "Researched about Artificial Intelligence and Operating Systems",
  },
  {
    year: 2020,
    text: "Learned about managing databases by using C.R.U.D. methods",
  },
  {
    year: 2021,
